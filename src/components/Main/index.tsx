                ...
                <StyledContainer>
                    ...
                    <ul>
                        <li>
                            ...
                            <p>
                                Nossa equipe coleta seu dispositivo para
                                análise, avaliamos e identificamos a melhor
                                solução através de testes.
                            </p>
                        </li>
                        <li>
                            <div>
                            ...
                            <p>
                                Elaboramos o relatório completo que será
                                encaminhado ao cliente, após aprovação iniciamos
                                o serviço.
                            </p>
                        </li>
                        <li>
